<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="dao.pool.ConnectionPool" %>
    <%!
public void jspInit() { 
...
<%
	if(request.getParameter("username")!=null && request.getParameter("password")!=null){
		...
		if(managerService.login(request.getParameter("username"),request.getParameter("password")))
			response.sendRedirect("announcements.jsp");
		else session.setAttribute("alert-danger","Wrong credentials!");
	}

%>
	<%@include file="/WEB-INF/no_menu_header.jsp" %>
